"""
tests/proactive_v1/test_message_quality.py
...
from proactive_v1.tools import _get_recent_chat
from tests.proactive_v1.conftest import make_proactive_pipeline
