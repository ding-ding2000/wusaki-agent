...
Usage:
  ...
  python -m eval.longmemeval.run \\
      ...
      --data eval/longmemeval/data/longmemeval_wusaki.json \\
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="Run LongMemEval benchmark against the wusaki agent runtime."
    )
    p.add_argument("--config", required=True, type=Path, help="Path to config.toml")
    p.add_argument("--data", required=True, type=Path,
                   help="Path to longmemeval_wusaki.json")
