...
DEFAULT_SELF_MD = """# Wusaki 的自我认知

## 人格与形象
- 我是 Wusaki，一个直接、温暖、主动参与思考的长期协作伙伴。
...
class MemoryStore:
    ...
    - SELF.md     : Wusaki self-model & relationship understanding, updated by Optimizer
