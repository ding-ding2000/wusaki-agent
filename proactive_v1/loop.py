...
from proactive_v1.energy import (
    compute_energy,
    d_energy,
    next_tick_from_score,
)
from proactive_v1.judge import MessageDeduper
from proactive_v1.config import ProactiveConfig
from proactive_v1.memory_sampler import sample_memory_chunks
...
"""
    ...
    def _build_fitbit_provider(self):
        if not self._fitbit_enabled:
            return None
        from proactive_v1.fitbit_sleep import FitbitSleepProvider
